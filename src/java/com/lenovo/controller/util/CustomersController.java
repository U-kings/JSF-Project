...
import com.lenovo.model.Customers;
import com.lenovo.bean.CustomersFacade;
...
public class CustomersController implements Serializable {
    ...
    @EJB
    private com.lenovo.bean.CustomersFacade ejbFacade;
    ...
    public static class CustomersControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Customers) {
                ...
                return getStringKey(o.getCustomerRef());
            } else {
