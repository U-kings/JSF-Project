...
import com.lenovo.model.Orders;
import com.lenovo.bean.OrdersFacade;
...
public class OrdersController implements Serializable {
    ...
    @EJB
    private com.lenovo.bean.OrdersFacade ejbFacade;
    ...
    public static class OrdersControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Orders) {
                ...
                return getStringKey(o.getOrderNo());
            } else {
